    ...
    <div className="dark min-h-screen w-full bg-gradient-to-br from-slate-950 via-purple-950 to-slate-900 relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex">
          ...
          <div className="max-w-xl">
            <div className="mb-12">
              ...
              <p className="text-2xl text-purple-200/80 font-light">
                Organize seus objetivos financeiros com inteligência
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4 group hover:translate-x-2 transition-transform duration-300">
                ...
                <div>
                  ...
                  <p className="text-purple-200/60">Defina e acompanhe seus objetivos financeiros</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 group hover:translate-x-2 transition-transform duration-300">
                ...
                <div>
                  ...
                  <p className="text-purple-200/60">Visualize seu progresso instantaneamente</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 group hover:translate-x-2 transition-transform duration-300">
                ...
                <div>
                  ...
                  <p className="text-purple-200/60">Deixe a IA trabalhar por você</p>
                </div>
              </div>
            </div>

            <div className="mt-16 flex items-center gap-3 text-purple-300/60">
        ...
        <div className="w-[600px] flex items-center justify-center p-16 relative">
          <div className="absolute inset-0 bg-gradient-to-l from-slate-900/50 to-transparent backdrop-blur-sm" />
          ...
          <div className="relative w-full max-w-md">
            ...
            <div className="absolute -z-10 top-10 -right-10 w-32 h-32 bg-purple-500/10 rounded-full blur-2xl animate-pulse" />
            <div className="absolute -z-10 bottom-10 -left-10 w-32 h-32 bg-blue-500/10 rounded-full blur-2xl animate-pulse delay-500" />
          </div>
        </div>
      </div>
    </div>
